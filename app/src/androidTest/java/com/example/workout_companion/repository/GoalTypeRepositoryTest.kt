...
class GoalTypeRepositoryTest : TestCase() {
    ...
    private lateinit var repository: GoalTypeRepository
    ...
    public override fun setUp() {
        ...
        dao = db.goalTypeDao()
        repository = GoalTypeRepository(dao)
    }
    ...
    @Test
    fun observeAllGoalsTest() = runBlocking() {
        val goals = getGoalTestValues(10)
        for (goal in goals) {
            repository.addGoal(goal)
        }

        assertEquals(repository.allGoals.getOrAwaitValue(), goals)
    }
}