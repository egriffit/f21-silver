...
interface FrameworkComponentDao {
     ...
     * @param framework_day_id, id for framework_day
     * @param muscle_group, MuscleGroup enum for muscle group,
     * @param target_reps, goal for the number of reps
     * @param target_sets, goal for the number of sets
     */
    @Query("""
